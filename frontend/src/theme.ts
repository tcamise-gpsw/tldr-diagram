...
export const FOCUS_ICON_COLOR = '#a371f7';
export const FOCUS_ICON_HOVER_BG = 'rgba(163, 113, 247, 0.15)';
export const SOURCE_ICON_COLOR = '#388bfd';
export const SOURCE_ICON_HOVER_BG = 'rgba(56, 139, 253, 0.15)';
